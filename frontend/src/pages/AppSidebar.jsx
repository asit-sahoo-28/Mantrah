...
const AppSidebar = () => {
  ...
  return (
    <>
      {/* ================= DESKTOP SIDEBAR ================= */}
      <aside
        className="hidden md:flex fixed top-[5.5rem] left-0 w-64
                   h-[calc(100vh-5.5rem)]
                   bg-slate-700 border-r border-slate-600 z-40"
      >
        <ul className="flex flex-col gap-2 p-4 pt-6 w-full">
      ...
      >
        <div className="flex justify-around py-2">
          ...
          <NavLink to="/admin-dashboard/add-photo" className={mobileLinkClass}>
            {({ isActive }) => (
              <>
                <FaImage className={`text-lg mb-1 ${isActive ? "text-indigo-300" : ""}`} />
                Photo
              </>
            )}
          </NavLink>
          ...
          <NavLink to="/admin-dashboard/add-video" className={mobileLinkClass}>
            {({ isActive }) => (
              <>
                <FaVideo className={`text-lg mb-1 ${isActive ? "text-indigo-300" : ""}`} />
                Video
              </>
            )}
          </NavLink>
          ...
          <NavLink to="/admin-dashboard/add-event" className={mobileLinkClass}>
            {({ isActive }) => (
              <>
                <FaCalendarPlus className={`text-lg mb-1 ${isActive ? "text-indigo-300" : ""}`} />
                Event
              </>
            )}
          </NavLink>
          ...
          <NavLink to="/admin-dashboard/show-data" className={mobileLinkClass}>
            {({ isActive }) => (
              <>
                <FaTable className={`text-lg mb-1 ${isActive ? "text-indigo-300" : ""}`} />
                Data
              </>
            )}
          </NavLink>
          ...
          <button
            onClick={handleLogout}
            className="flex flex-col items-center text-xs text-red-300"
          >
